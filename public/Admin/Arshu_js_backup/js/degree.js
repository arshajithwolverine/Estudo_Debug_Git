      ...
      <div class="col">
          <div class="card">
            ...
            <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h6 class="h2 text-black d-inline-block mb-0">COURSES</h6>
                </div>
                <div class="col-lg-6 col-5 text-right">
...
<div>
    <table class="table align-items-center">
      ...
      <label for="example-text-input" class="form-control-label">X For Name</label>
      <input class="form-control" type="text" id="xforname" value="${snapshot.data().Certificate.XforName}">
    </div>
  
    <div class="form-group">
      <label for="example-text-input" class="form-control-label">Y For Name</label>
      <input class="form-control" type="text" id="yforname" value="${snapshot.data().Certificate.YforName}">
    </div>
  
    <div class="form-group">
      <label for="example-text-input" class="form-control-label">X For Date</label>
      <input class="form-control" type="text" id="xfordate" value="${snapshot.data().Certificate.XforDate}">
    </div>
  
    <div class="form-group">
      <label for="example-text-input" class="form-control-label">Y For Date</label>
      <input class="form-control" type="text" id="yfordate" value="${snapshot.data().Certificate.YforDate}">
    </div>
              ...
              <div class="row">
                ...
                <label for="example-text-input" class="form-control-label" style="margin-right:10px">Active</label>
                      <label class="custom-toggle">
                        ...
                        <form style="margin-bottom: 20px;">
                            <textarea class="form-control" rows="5" placeholder="Details...." id="preview-details"></textarea>
                        </form>
                        <div class="form-group">
                          <label for="example-text-input" class="form-control-label">Price</label>
            ...
            <div class="row">
              ...
              <label for="example-text-input" class="form-control-label" style="margin-right:10px">Active</label>
                    ...
                    <div class="form-group">
                      ...
                      <form style="margin-bottom: 20px;">
                          <textarea class="form-control" rows="5" placeholder="Details...." id="preview-details">${snapshot.data().details}</textarea>
                      </form>
                      <div class="form-group">
                        <label for="example-text-input" class="form-control-label" >Price</label>
...
async function courses_AddToDatabase_preview(docid, previewid) {
  ...
  let preview_details = document.getElementById('preview-details').value;
  ...
  if (checkempty("Topic", preview_topic) || checkempty("Details", preview_details) || checkempty("Price", preview_price)) {
    return;
  }
