...
function Banner_ios() {
    ...
    let header = `<div class="row" style="flex:1" >
      <div class="col-6" style="flex:1">
        <div class="card card-stats">
          <!-- Card body -->
          <div class="card-body" style="cursor: pointer;" onclick="Banner_ios()">
            <div class="row">
              <div class="col text-center">
                <h5 class="card-title text-uppercase text-muted mb-0">Home Page</h5>
                <span class="h2 font-weight-bold mb-0" onclick="Banner_ios()">Home Page</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-6" style="flex:1">
        <div class="card card-stats">
          <!-- Card body -->
          <div class="card-body" style="cursor: pointer;" onclick="Net_Banner_ios()">
            <a>
              <div class="row">
                <div class="col text-center">
                  <h5 class="card-title text-uppercase text-muted mb-0">UGC Net</h5>
                  <span class="h2 font-weight-bold mb-0" onclick="Net_Banner_ios()">UGC Net</span>
                </div>
              </div>
        ...
        <div class="card card-stats">
          <!-- Card body -->
          <div class="card-body" style="cursor: pointer;" onclick="Degree_Banner_ios()">
            <a>
              <div class="row">
                <div class="col text-center">
                  <h5 class="card-title text-uppercase text-muted mb-0">Degree Course</h5>
                  <span class="h2 font-weight-bold mb-0" onclick="Degree_Banner_ios()">Degree Course</span>
                </div>
              </div>
        ...
        <div class="card card-stats">
          <!-- Card body -->
          <div class="card-body" style="cursor: pointer;" onclick="Skilled_Banner_ios()">
            <a>
              <div class="row">
                <div class="col text-center">
                  <h5 class="card-title text-uppercase text-muted mb-0">Skilled Course</h5>
                  <span class="h2 font-weight-bold mb-0" onclick="Skilled_Banner_ios()">Skilled Course</span>
                </div>
              </div>
      ...
      <div class="card card-stats">
        <!-- Card body -->
        <div class="card-body" style="cursor: pointer;" onclick="Course_Banner_ios()">
          <a>
            <div class="row">
              <div class="col text-center">
                <h5 class="card-title text-uppercase text-muted mb-0">Life Style Course</h5>
                <span class="h2 font-weight-bold mb-0" onclick="Course_Banner_ios()">Life Style Course</span>
              </div>
            </div>
        ...
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="add_banner_homepage_ios(null,true,'home')">Add</a>
              </div>                    
              </div>
          </div>
    ...
    //loading table data
    db.collection('Banners_IOS').where('HomeFlag', '==', true).orderBy('Index').onSnapshot(snapshot => {
        html = ``;
        snapshot.forEach(doc => {
            add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="add_banner_homepage_ios('${doc.id}',true,'home')"><u>${doc.data().Name}</u></a></th>
                      <td>${doc.data().Index}</td>
                      <td>${doc.data().Active}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="delete_banner_ios(this,'${doc.id}')" >Delete</a></td>
                    </tr>
          `;
            html = html + add;
        });
...
function Net_Banner_ios() {
        ...
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="add_banner_homepage_ios(null,false,'net')">Add</a>
              </div>                    
              </div>
          </div>
          <div class="table-responsive" style="overflow-y: hidden;">
    ...
    document.getElementById('table-list').innerHTML = table;
    //loading table data
    db.collection('Banners_IOS').where('inside', '==', 'net').orderBy('Index').onSnapshot(snapshot => {
        html = ``;
        snapshot.forEach(doc => {
            add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="add_banner_homepage_ios('${doc.id}',false,'net')"><u>${doc.data().Name}</u></a></th>
                      <td>${doc.data().Index}</td>
                      <td>${doc.data().Active}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="delete_banner_ios(this,'${doc.id}')" >Delete</a></td>
                    </tr>
...
function Degree_Banner_ios() {
        ...
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="add_banner_homepage_ios(null,false,'degree')">Add</a>
              </div>                    
              </div>
          </div>
          <div class="table-responsive" style="overflow-y: hidden;">
    ...
    document.getElementById('table-list').innerHTML = table;
    //loading table data
    db.collection('Banners_IOS').where('inside', '==', 'degree').orderBy('Index').onSnapshot(snapshot => {
        html = ``;
        snapshot.forEach(doc => {
            add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="add_banner_homepage_ios('${doc.id}',false,'degree')"><u>${doc.data().Name}</u></a></th>
                      <td>${doc.data().Index}</td>
                      <td>${doc.data().Active}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="delete_banner_ios(this,'${doc.id}')" >Delete</a></td>
                    </tr>
...
function Skilled_Banner_ios() {
        ...
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="add_banner_homepage_ios(null,false,'skilled')">Add</a>
              </div>                    
              </div>
          </div>
          <div class="table-responsive" style="overflow-y: hidden;">
    ...
    document.getElementById('table-list').innerHTML = table;
    //loading table data
    db.collection('Banners_IOS').where('inside', '==', 'skilled').orderBy('Index').onSnapshot(snapshot => {
        html = ``;
        snapshot.forEach(doc => {
            add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="add_banner_homepage_ios('${doc.id}',false,'skilled')"><u>${doc.data().Name}</u></a></th>
                      <td>${doc.data().Index}</td>
                      <td>${doc.data().Active}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="delete_banner_ios(this,'${doc.id}')" >Delete</a></td>
                    </tr>
...
function Course_Banner_ios() {
        ...
        <div class="card bg-default shadow">
          <div class="card-header bg-transparent border-0">
            <div class="row">
              ...
              <div class="col-lg-6 col-5 text-right">
                <a href="#" class="btn btn-md btn-neutral" onclick="add_banner_homepage_ios(null,false,'course')">Add</a>
              </div>                    
              </div>
          </div>
          <div class="table-responsive" style="overflow-y: hidden;">
    ...
    document.getElementById('table-list').innerHTML = table;
    //loading table data
    db.collection('Banners_IOS').where('inside', '==', 'course').orderBy('Index').onSnapshot(snapshot => {
        html = ``;
        snapshot.forEach(doc => {
            add = `
                    <tr>
                      <th><a href="#" class="text-white" onclick="add_banner_homepage_ios('${doc.id}',false,'course')"><u>${doc.data().Name}</u></a></th>
                      <td>${doc.data().Index}</td>
                      <td>${doc.data().Active}</td>
                      <td class="text-right"><a class="btn btn-sm btn-neutral  text-dark" href="#"onclick="delete_banner_ios(this,'${doc.id}')" >Delete</a></td>
                    </tr>
...
async function add_banner_homepage_ios(docid, homeflag, inside) {
    ...
    if (docid == null) {
            ...
            <div class="card-header bg-transparent border-0" style="padding-bottom: inherit;">
              <div class="row">
                ...
                <div class="col-lg-6 col-5 text-right" id='topic-save-update'>
                  <a href="#" class="btn btn-md btn-neutral" onclick="AddToDatabase_Banner_ios('${docid}','none',${homeflag},'${inside}')">Save</a>
                </div>
                </div>
              </div>
      ...
      `
        document.getElementById('rendercontent.js').innerHTML = html;
        Banner_AddOn_ios(null, homeflag, inside);
        //ToggleBtw();
    }
    else {

        db.collection('Banners_IOS').doc(docid).get().then(snapshot => {
          ...
          `
            ...
            document.getElementById('topic-save-update').innerHTML = `<a href="#" class="btn btn-md btn-neutral" onclick="AddToDatabase_Banner_ios('${docid}','${snapshot.data().Type}',${homeflag},'${inside}')">Save</a>
            `;
            Banner_AddOn_ios(docid, homeflag, inside);
...
async function Banner_AddOn_ios(docid, homeflag, inside) {

    if (docid === null) {
        let html = `<div class="form-group">
                        <label for="example-text-input" class="form-control-label">Select Type</label>
                        <select class="form-control" id="select-type" onchange="banner_paper_select_ios(this,'${docid}',${homeflag},'${inside}')">
                        </select>
                    </div>
        ...
        let doc = await db.collection('Banners_IOS').doc(docid).get();
        let html = `<div class="form-group">
        <label for="example-text-input" class="form-control-label">Select Type</label>
        <select class="form-control" id="select-type" onchange="banner_paper_select_ios(this,'${docid}',${homeflag},'${inside}')">
        </select>
    ...
    <option value="course">LIFE STYLE COURSE</option>`;
        ...
        banner_paper_select_ios(null, docid, homeflag, inside);
...
async function banner_paper_select_ios(input, docid, homeflag, inside) {
    ...
    if (docid === 'null') {
        if (type === "SELECT TYPE") {
            ...
            document.getElementById('topic-save-update').innerHTML = `
            <a href="#" class="btn btn-md btn-neutral" onclick="AddToDatabase_Banner_ios('${docid}','net',${homeflag},'${inside}')">Save</a>
            `;
            let html_data = `
            <div class="form-group">
            ...
            <div class="form-group">
                              ...
                              <select class="form-control" id="select-paper" onchange="paper_select_ios(this,'name')">
                             </select>
                            </div>
            `;
            ...
            document.getElementById('topic-save-update').innerHTML = `
            <a href="#" class="btn btn-md btn-neutral" onclick="AddToDatabase_Banner_ios('${docid}','degree',${homeflag},'${inside}')">Save</a>
            `;
            let html_data = `
            <div class="form-group">
                                  <label for="example-text-input" class="form-control-label">Paper Name</label>
            ...
            document.getElementById('topic-save-update').innerHTML = `
            <a href="#" class="btn btn-md btn-neutral" onclick="AddToDatabase_Banner_ios('${docid}','skilled',${homeflag},'${inside}')">Save</a>
            `;
            let html_data = `
            <div class="form-group">
                                  <label for="example-text-input" class="form-control-label">Paper Name</label>
            ...
            document.getElementById('topic-save-update').innerHTML = `
            <a href="#" class="btn btn-md btn-neutral" onclick="AddToDatabase_Banner_ios('${docid}','course',${homeflag},'${inside}')">Save</a>
            `;
            let html_data = `
            <div class="form-group">
                                  <label for="example-text-input" class="form-control-label">Paper Name</label>
        ...
        if (type === "SELECT TYPE") {
            ...
            document.getElementById('topic-save-update').innerHTML = `
            <a href="#" class="btn btn-md btn-neutral" onclick="AddToDatabase_Banner_ios('${docid}','${type}',${homeflag},'${inside}')">Save</a>
            `;
            let html_data = `
            <div class="form-group">
                                  <label for="example-text-input" class="form-control-label">Paper Name</label>
...
function paper_select_ios(input, type) {
...
async function AddToDatabase_Banner_ios(docid, type, homeflag, inside) {
    ...
    if (topicimage.files[0] != undefined) {
        ...
        uploadpdf_banner_ios(docid, false, filelocation, topicimage.files[0], imageprogressno, imageprogressbar);
    }
    ...
    if (docid === 'null') {
        ...
        db.collection('Banners_IOS').add(topicdata)
            .then(snap => {
                if (pdffileno == 0) {
                    alert("Updation Finished")
                    console.log("reached inside database")
                    toggle_homepage_ios(docid, subid);
        ...
        db.collection('Banners_IOS').doc(docid).update(topicdata)
            .then(snap => {
                if (pdffileno == 0) {
                    alert("Updation Finished")
                    toggle_homepage_ios();
...
async function uploadpdf_banner_ios(docid, pdfornot, filelocation, input, subjectprogressno, subjectprogressbar) {
    var flag = 0;
    console.log(input)
...
function delete_banner_ios(input, docid) {
    if (docid != null) {
        if (confirm("Are you sure to delete the main Subject") == false) {
            return
        }
        db.collection('Banners_IOS').doc(docid).delete()
    }
